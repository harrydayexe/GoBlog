...
//
// WithMeterProvider(mp metric.MeterProvider) is a BaseServerOption that sets
...
// cache-control TTL, health-check endpoints, meter provider, and via the
// embedded BaseOption: WithLogger, WithBlogRoot, WithAssetsDir).
